    ...
    public void init() {
        try {
            ...
            if (luceneConfig.isShouldInitializeIndex()) {
                ...
                deleteNonEmptyDirectory(Paths.get(luceneConfig.getIndexDirectory())); 
                deleteNonEmptyDirectory(Paths.get(luceneConfig.getTableDirectory())); 
                deleteNonEmptyDirectory(Paths.get(luceneConfig.getFigureDirectory())); 
                // Initialize the index
                indexArticles(luceneConfig.getIndexDirectory(), Codec.getDefault()); 
